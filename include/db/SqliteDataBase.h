    ...
    static auto initMapStorage() {
        return make_storage(SEGMENTATION_SQLITE_PATH,
                            make_table("map",
                                       ...
                                       make_column("elevator_position_x", &MapPo::elevator_position_x,
                                                   default_value(0)),
                                       make_column("elevator_position_y", &MapPo::elevator_position_y,
                                                   default_value(0)),
                                       make_column("elevator_position_z", &MapPo::elevator_position_z,
                                                   default_value(0)),
                                       make_column("elevator_orientation_x", &MapPo::elevator_orientation_x,
                                                   default_value(0)),
                                       make_column("elevator_orientation_y", &MapPo::elevator_orientation_y,
                                                   default_value(0)),
                                       make_column("elevator_orientation_z", &MapPo::elevator_orientation_z,
                                                   default_value(0)),
                                       make_column("elevator_orientation_w", &MapPo::elevator_orientation_w,
                                                   default_value(0)),

                                       make_column("elevator_inside_position_x", &MapPo::elevator_inside_position_x,
                                                   default_value(0)),
                                       make_column("elevator_inside_position_y", &MapPo::elevator_inside_position_y,
                                                   default_value(0)),
                                       make_column("elevator_inside_position_z", &MapPo::elevator_inside_position_z,
                                                   default_value(0)),
                                       make_column("elevator_inside_orientation_x",
                                                   &MapPo::elevator_inside_orientation_x,
                                                   default_value(0)),
                                       make_column("elevator_inside_orientation_y",
                                                   &MapPo::elevator_inside_orientation_y,
                                                   default_value(0)),
                                       make_column("elevator_inside_orientation_z",
                                                   &MapPo::elevator_inside_orientation_z,
                                                   default_value(0)),
                                       make_column("elevator_inside_orientation_w",
                                                   &MapPo::elevator_inside_orientation_w,
                                                   default_value(0)),

                                       make_column("p1x", &MapPo::p1x, default_value(0)),
                                       make_column("p1y", &MapPo::p1y, default_value(0)),
                                       make_column("p2x", &MapPo::p2x, default_value(0)),
                                       make_column("p2y", &MapPo::p2y, default_value(0)),
                                       make_column("p3x", &MapPo::p3x, default_value(0)),
                                       make_column("p3y", &MapPo::p3y, default_value(0)),
                                       make_column("p4x", &MapPo::p4x, default_value(0)),
                                       make_column("p4y", &MapPo::p4y, default_value(0)),

                                       make_column("floor", &MapPo::floor, default_value(0)),
                                       make_column("base_station", &MapPo::base_station, default_value(false))
                            ),
