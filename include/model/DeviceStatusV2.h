...
public:
    ...
    DeviceStatusV2(int mRsoc, long mCleanArea, long mCleanTime, const MapInfo &mCurrentMap,
                   ...
                   const string &mWorkStatusMessage, int mWorkStatusCode, const string &version, bool has_facerecognition,
                   bool has_basestation,bool hasknob,bool hasvoice, const string &device_ros_version, const string &ecu_softversion, 
