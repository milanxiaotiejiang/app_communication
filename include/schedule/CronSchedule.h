...
namespace croncpp
{
    ...
    {
        public:
            explicit CronSchedule(CronData& data) : data(data)  {  }
            ...
            std::tuple<bool, std::chrono::system_clock::time_point>
            calculate_from_end(const std::chrono::system_clock::time_point& from,int endYear) const;
