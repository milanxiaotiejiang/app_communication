...
#define  CRONCPP_CONSTEXPTR
    ...
    struct cron_standard_traits {
        ...
        static std::vector<std::string> &MONTHS() {
            static std::vector<std::string> months = {"NIL", "JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG",
                                                      "SEP", "OCT", "NOV", "DEC"};
            return months;
        }
    ...
    struct cron_oracle_traits {
        ...
        static std::vector<std::string> &MONTHS() {
            static std::vector<std::string> months = {"JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP",
                                                      "OCT", "NOV", "DEC"};
            return months;
        }
    ...
    cron_next(cronexpr const &cex, std::chrono::system_clock::time_point const &time_point) {
