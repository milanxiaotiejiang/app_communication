...
#ifndef APP_COMMUNICATION_TIMELY_CALL_H
#define APP_COMMUNICATION_TIMELY_CALL_H

#include "task/async_task_call.h"

class TimelyPointCall : public AsyncTaskCall {
public:
...
#endif //APP_COMMUNICATION_TIMELY_CALL_H
