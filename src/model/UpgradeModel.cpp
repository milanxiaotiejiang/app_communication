...
CleanHistoryUpgrade::CleanHistoryUpgrade(bool isComplete, long launchTime, long executeTime, long endTime, int taskMode,
                                         ...
                                         const std::string &o_map_id) : is_complete(isComplete),
                                                                        launch_time(launchTime),
                                                                        execute_time(executeTime),
                                                                        end_time(endTime),
                                                                        task_mode(taskMode),
                                                                        ...
                                                                        error_message(errorMessage),
                                                                        m_base_complete(mBaseComplete),
                                                                        task_type(taskType),
                                                                        component_id_list_(componentIdList),
                                                                        skip_path_point_count_(skipPathPointCount),
                                                                        ...
                                                                        current_frquency_(currentFrquency),
