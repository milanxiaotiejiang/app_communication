...
namespace croncpp {
    ...
    std::tuple<bool, std::string> CronRandomization::parse(const std::string &cron_schedule) {
        ...
        if (res) {
            ...
            CronData::replace_string_name_with_numeric<croncpp::Months>(month);
            ...
            CronData::replace_string_name_with_numeric<croncpp::DayOfWeek>(dow);
